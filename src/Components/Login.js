...
const Login = () => {
    ...
    const [modalContent, setModalContent] = useState({title: '', message: '',authtoken: ''});
                  ...
                  <form onSubmit={submitForm} method='post'>
                    <div className="row gy-3 overflow-hidden">
                      ...
                      <div className="col-12">
                        ...
                        <ReactModal isOpen={isModalOpen} style={customStyles} onRequestClose={() => setModalOpen(false)}>
                            ...
                            {modalContent.authtoken && (
                                ...
                                <code>{modalContent.authtoken}</code><br/>
                                <button className="btn-clipboard my-2" style={{width: '230px'}} onClick={copyAuthToken}><i className="fa-solid fa-clone mx-2"></i>{clipboardBtn}</button><br/>
                                </>
                            )}
                            <button className='my-2' style={{    
                                position: 'relative',
                                left: '43%'}}onClick={() => {setModalOpen(false); navigate('/myacc')}}>Close Modal</button>
                        </ReactModal>
                  <div className="row">
                    <div className="col-12">
